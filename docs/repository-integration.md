...
| `test` | GitHub-hosted | Trusted device or Jelly, subject to health |
| `build` | GitHub-hosted | Jelly for constrained builds, Zombie for burst work |
| `fallback` | Never the default | Gurbet when explicitly selected or quota policy allows it |
